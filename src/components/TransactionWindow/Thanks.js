  ...
  return (
    <>
      <h2 className="thanks-content">
        Welcome to the world of AI trading with our Premium
        subscription. <br/> We will be contacting you shortly.<br/> Thank you for
        your choice.
      </h2>
      <svg 
